...
urlpatterns = [
	...
	url(ur'^biografias/(?P<filtro>[a-zA-Z ]+/)?$', views.BiografiaView.as_view(), name='biografias'),
	...
	url(ur'^discotecas/(?P<filtro>[a-zA-Z ]+/)?$', views.DiscotecaView.as_view(), name='discotecas'),
